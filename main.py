...
def updateCarPos(vehicles: list[Vehicle], simulationWorld : World, dataManager : DataManager, accidentManager : AccidentManager): #TODO probably move to a different place
